...
class EngineS146:
    ...
    def start(self):
        ...
        summary = (
            ...
            f"Money lock: {CONFIG.s146_money_lock_enabled} | bank "
            f"{CONFIG.s146_money_lock_secure_mult}x margin once profit reaches "
            f"{CONFIG.s146_money_lock_trigger_mult}x margin (once per position)\n"
